...
<body>
    ...
    <nav class="navbar navbar-dark">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                <a href="vendors_new.php" class="btn btn-outline-light btn-sm me-2">
    ...
    <div class="container-fluid py-4">
        ...
        <!-- Page Header -->
        <div class="mb-4">
            <h1 class="mb-0"><i class="fas fa-star me-2"></i>Featured Products Management</h1>
            <p class="text-muted mb-0">Set and manage featured products for homepage display</p>
        </div>
