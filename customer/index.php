    ...
    <script>
        ...
        async function loadFeaturedProducts() {
            try {
                ...
                featuredContainer.innerHTML = featuredCards || '<div class="col-12 text-center text-muted">No featured products available</div>';
                ...
                topChoiceContainer.innerHTML = topChoiceCards || '<div class="col-12 text-center text-muted">No top choice products available</div>';
                
            } catch (error) {
                console.error('Failed to load featured products:', error);
                document.getElementById('featuredProductsGrid').innerHTML = '<div class="col-12 text-center text-danger">Failed to load featured products</div>';
                document.getElementById('topChoiceProductsGrid').innerHTML = '<div class="col-12 text-center text-danger">Failed to load top choice products</div>';
            }
        }
