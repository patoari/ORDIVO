...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-brand">
                ...
                if (!empty($sidebarLogoUrl) && $sidebarLogoUrl !== '🍔' && $sidebarLogoUrl !== '🍽️') {
                ...
                <?php if (!empty($sidebarLogoUrl) && $sidebarLogoUrl !== '🍔' && $sidebarLogoUrl !== '🍽️'): ?>
    ...
    <style>
        ...
        .sidebar {
            background: linear-gradient(135deg, var(--ordivo-dark) 0%, #2d2d2d 100%);
            min-height: 100vh;
            width: 250px;
            position: fixed;
            left: 0;
        ...
        .badge-primary { background: var(--ordivo-light); color: var(--ordivo-primary); }
...
<script>
// Fix for missing navigation sections
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        ...
        if (!document.getElementById('section-orders')) {
            ...
            ordersSection.id = 'section-orders';
            ordersSection.className = 'content-section';
            ordersSection.style.display = 'none';
            ordersSection.innerHTML = `
                <div class="section-header">
                    <h3 class="section-title">Order Management</h3>
                    <button class="btn btn-primary" onclick="alert('Order management coming soon!')">
                        <i class="fas fa-sync-alt me-2"></i>Refresh
                    </button>
                </div>
                <div class="table-responsive">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="7" class="text-center py-4">
                                    ...
                                    <span class="text-muted">Order management features coming soon</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        if (!document.getElementById('section-analytics')) {
            ...
            analyticsSection.innerHTML = `
                <div class="section-header">
                    ...
                    <button class="btn btn-primary" onclick="alert('Analytics coming soon!')">
                        <i class="fas fa-sync-alt me-2"></i>Refresh
                    </button>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-section">
                            ...
                            <ul class="text-muted">
                                <li>Revenue trends and financial reports</li>
                                <li>Order analytics and customer insights</li>
                                <li>Vendor performance metrics</li>
                                <li>Popular products and categories</li>
                                <li>Real-time dashboard with charts</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Close sidebar when clicking a nav link (for better UX)
    document.querySelectorAll('.nav-link').forEach(link => {
        link.addEventListener('click', function() {
            // Close sidebar after a short delay to see the selection
...
@keyframes pulse {
    0% { box-shadow: 0 4px 15px #f97316; }
    50% { box-shadow: 0 4px 25px #f97316; }
    100% { box-shadow: 0 4px 15px #f97316; }
}
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Close sidebar when clicking nav links (except logout)
